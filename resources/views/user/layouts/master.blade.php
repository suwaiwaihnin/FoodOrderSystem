            ...
            <div class="col-lg-3 d-none d-lg-block">
                <div class=" mt-3">
                    <a href="{{ route('user.home') }}" class="text-decoration-none">
                        <span class="h4  text-uppercase text-primary bg-dark px-2">My Shop</span>
                    </a>
                </div>
            </div>
            <div class="col-lg-9">
                        ...
                        <div class="navbar-nav ml-auto py-0 d-none d-lg-block">
                            <div class="dropdown d-inline me-5">
                                ...
                                <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                  <a class="dropdown-item my-3" href="{{ route('user.editProfile') }}"><i class="fa-solid fa-user me-1"></i>  Account</a>
                                  <a class="dropdown-item my-3" href="{{ route('user.changePassword') }}"><i class="fa-solid fa-key me-1"></i> Change Password</a>
    ...
    <div class="container-fluid bg-dark text-secondary mt-5 pt-5">
        ...
        <div class="row border-top mx-xl-5 py-4" style="border-color: rgba(256, 256, 256, .1) !important;">
            ...
            <div class="col-md-6 px-xl-0 text-center text-md-right">
                {{-- <img class="img-fluid" src="{{ asset('user/img/img/payments.png') }}" alt=""> --}}
            </div>
        </div>
    </div>
    <!-- Footer End -->
